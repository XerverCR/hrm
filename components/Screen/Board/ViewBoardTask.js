...
import {
    ...
    BackHandler, TouchableOpacity, Platform, KeyboardAvoidingView, AsyncStorage, FlatList,NetInfo, RefreshControl,
} from 'react-native';
...
export default class ViewBoardTask extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({ BordDetail: this.props.BoardDetail })
            ...
            try {
                ...
                fetch(urlDev + "RtTaskApi/SaveTask/", {
                    ...
                    .then(response => {
                        ...
                        this.gotoBordDetail(this.props.BoardDetail);
                    })
                    .catch(error => {
                        this.setState({ progressVisible: false });
                        console.log("error occured");
