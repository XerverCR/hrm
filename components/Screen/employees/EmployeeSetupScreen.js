...
export default class EmployeeSetupScreen extends React.Component {
    ...
    goToEmpDetail(item) {
        ...
        this.setState({ IsAutoCheckPoint: item.IsAutoCheckPoint })
        this.setState({ AutoCheckPointTime: item.AutoCheckPointTime })
    ...
    _handleDatePicked1 = (date) => {
        this.setState({ AutoCheckPointTime: moment(date).format("HH:mm:ss") })
                    ...
                    >
                        <View>
                            <TextInput
                                ...
                                value={this.state.AutoCheckPointTime}
                            />
                        </View>
                    </TouchableOpacity>
                    <DateTimePicker
